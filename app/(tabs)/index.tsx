      ...
      >
        ...
        <View style={styles.motivationCard}>
          ...
          <View style={styles.motivationText}>
            <Text style={styles.motivationTitle}>
              Dan {new Date().getDate()}. — Počni danas!
            </Text>
        ...
        <View style={styles.actionsGrid}>
          <Pressable
            ...
            onPress={() => handleQuickAction("Novi trening")}
          >
          ...
          <Pressable
            style={styles.actionCard}
            onPress={() => handleQuickAction("Vježbe")}
          >
          ...
          <Pressable
            style={styles.actionCard}
            onPress={() => handleQuickAction("Raspored")}
          >
          ...
          <Pressable
            style={styles.actionCard}
            onPress={() => handleQuickAction("Statistika")}
          >
        ...
        {loading ? (
          ...
          <View style={styles.emptyCard}>
            ...
            <Text style={styles.emptySubText}>
              Idi na tab "Treninzi" i dodaj svoj prvi trening!
            </Text>
          </View>
        ) : (
          <View>
